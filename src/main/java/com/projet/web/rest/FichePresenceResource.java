...
public class FichePresenceResource {
    ...
    /**
     * {@code GET  /fiche-presences/export} : count all the fichePresences.
     *
     * @param criteria the criteria which the requested entities should match.
     * @throws Exception
     */

    @GetMapping("/fiche-presences/export")
    public void ExportFic(HttpServletResponse response) throws Exception {
